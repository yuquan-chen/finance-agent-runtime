"""自动提取的 pay_settle_record 表 schema。"""
from finance_agent.metadata.table_registry import register_table


@register_table(name="pay_settle_record", description="")
class PaySettleRecord:
    COLUMNS = {
        "id_no": {"type": "bigint"},
        "account_id": {"type": "uuid", "description": "账户ID"},
        "pay_settle_id": {"type": "uuid", "description": "关联的结算ID"},
        "pay_order_id": {"type": "uuid", "description": "关联的支付订单ID"},
